        ...
        private void timerDateTime_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                if (RecordZone1 == true)
                {
                    ...
                    streamWriterZone1.WriteLine(DateTime.Now.ToString("MM:dd:yy") + "," + DateTime.Now.ToString("HH:mm:ss") + "," + temperatureValueOmron1);
                }
            }
            catch (Exception MS)
            {
            ...
            try
            {
                ...
                if (RecordZone2 == true)
                {
                    ...
                    streamWriterZone2.WriteLine(DateTime.Now.ToString("MM:dd:yy") + "," + DateTime.Now.ToString("HH:mm:ss") + "," + temperatureValueOmron2);
                }
